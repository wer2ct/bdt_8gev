...
if __name__ == '__main__':
    ...
    parser.add_option('--out_name', dest='out_name', default='bdt_v2', help='Output Pickle Name')
    ...
    parser.add_option('--sig_dir', dest='sig_dir', default='/project/hep_aag/ldmx/ap/visibles/produced/8_GeV/v14/no_disc_training/', help='name of signal file directory')
