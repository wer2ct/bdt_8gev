    ...
    def __init__(self, dn, maxEvts, trainFrac, isBkg):
        ...
        for filename in os.listdir(dn):
            ...
            for event in tree:
                ...
                if Eupstream < 3160 and E_hcal > 4840 and recoil_E < 2400: #trigger, energy requirement, and tracker veto, (cutflow up until the BDT)
                    #print('passed onto the bdt\n')
                    layershit = []
...
if __name__ == '__main__':
    ...
    parser.add_option('--out_dir', dest='out_dir', default='sfs/qumulo/qhome/wer2ct/LDMX/ldmx-analysis/bdt_8gev/weights/', help='Output directory')
    parser.add_option('--out_name', dest='out_name', default='bdt_v2_fixed', help='Output Pickle Name')
    ...
    parser.add_option('--bkg_dir', dest='bkg_dir', default='/project/hep_aag/ldmx/background/8GeV/no_disc_training/', help='name of background file directory')
    parser.add_option('--sig_dir', dest='sig_dir', default='/project/hep_aag/ldmx/ap/visibles/produced/8_GeV/v14/large_training/', help='name of signal file directory')
