    ...
    def __init__(self, dn, maxEvts, trainFrac, isBkg):
        ...
        for filename in os.listdir(dn):
            ...
            for event in tree:
                ...
                if Eupstream < 3160 and E_hcal > 4840:
                    #tracker veto
                    e_list = []
                    recoil_E = 0
...
if __name__ == '__main__':
    ...
    parser.add_option('--out_name', dest='out_name', default='m005_v2_fixed_pref', help='Output Pickle Name')
    parser.add_option('--bdt_path', dest='bdt_path', default='/sfs/qumulo/qhome/wer2ct/LDMX/ldmx-analysis/bdt_8gev/weights/bdt_v2_fixed_3/bdt_v2_fixed_3_weights.pkl', help='BDT model to load in')
    ...
    parser.add_option('--sig_dir', dest='sig_dir', default='/project/hep_aag/ldmx/ap/visibles/produced/8_GeV/v14/testing/m005_testing', help='name of signal file directory')
